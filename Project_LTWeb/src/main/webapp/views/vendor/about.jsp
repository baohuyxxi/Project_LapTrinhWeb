    ...
    <section class="bg-success py-5">
        <div class="container">
            <div class="row align-items-center py-5">
                ...
                <div class="col-md-4">
                    <img src="<c:url value="/assets/img/about-hero.svg"/>" alt="About Hero">
                </div>
            </div>
        </div>
    </section>
                                ...
                                <div class="carousel-inner product-links-wap" role="listbox">
                                    ...
                                    <div class="carousel-item">
                                        <div class="row">
                                            ...
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src="https://www.freepnglogos.com/uploads/instagram-logo-png-transparent-background-hd-3.png" alt="Brand Logo"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <!--End Second slide-->
