				...
				<div class="container">
					<div class="row p-5">
						<div class="mx-auto col-md-8 col-lg-6 order-lg-last">
							<img class="img-fluid"
								src="<c:url value="/assets/img/banner_img_01.jpg"/>" alt="" />
						</div>
						<div class="col-lg-6 mb-0 d-flex align-items-center">
							<div class="text-align-left align-self-center">
								...
								<p>
									Zay Vendor là một trang web dành cho người bán để họ có thể
									theo dõi công việc của mình Rất vui được hợp tác với bạn <a
										rel="sponsored" class="text-success"
										href="https://templatemo.com" target="_blank"></a> .
								</p>
							</div>
						</div>
					</div>
			...
			<div class="carousel-item">
				<div class="container">
					<div class="row p-5">
						<div class="mx-auto col-md-8 col-lg-6 order-lg-last">
							<img class="img-fluid"
								src="<c:url value="/assets/img/banner_img_02.jpg"/>" alt="" />
						</div>
						<div class="col-lg-6 mb-0 d-flex align-items-center">
							<div class="text-align-left">
								...
								<p>
									Bạn sử dụng trang web để đăng thông tin sản phẩm Bạn có thể
									liên lạc <strong>Admin</strong> để biết thêm thông tin chi
									tiết.
								</p>
							</div>
						</div>
			...
			<div class="carousel-item">
				<div class="container">
					<div class="row p-5">
						<div class="mx-auto col-md-8 col-lg-6 order-lg-last">
							<img class="img-fluid"
								src="<c:url value="/assets/img/banner_img_03.jpg"/>" alt="" />
						</div>
						<div class="col-lg-6 mb-0 d-flex align-items-center">
							<div class="text-align-left">
								<h1 class="h1">Theo dõi đơn hàng</h1>
								<h3 class="h2">Quản lý cửa hàng</h3>
								<p>Bạn có thể theo dõi cửa hàng, đơn hàng, sản phẩm của
									mình. Bạn có thể làm việc ở bất cứ đâu, bán hàng thoải mái.</p>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="modal-body">
						...
						<p>
							<b><font face="Helvetica" size="5" color="#0080ff">Phần
									chém gió</font></b> </font><img height="70" width="70" alt="Mạng yếu quá :v"
						...
						<p>
							<font face="Helvetica" size="4" color="#000000">-Thứ 1:<font
								face="Helvetica" size="5" color="#00ff00">Qua môn</font></b>
							</font><img height="32" width="32" alt=":v"
								src="https://static.xx.fbcdn.net/images/emoji.php/v9/e7e/1.5/32/PACMAN.png"></b>
						</p>
						<p>
							<font face="Helvetica" size="4" color="#000000">-Thứ 2:
								Điểm cao</font></b>
						</p>
						<p>
							<font face="Helvetica" size="4" color="#000000">-Thứ 3: Cả
								2 điều trên</font></b>
						</p>
