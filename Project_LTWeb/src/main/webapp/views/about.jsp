                                ...
                                <div class="carousel-inner product-links-wap" role="listbox">
                                    ...
                                    <div class="carousel-item">
                                        <div class="row">
                                            ...
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src="<c:url value="assets/img/brand_03png"/>"  alt="Brand Logo"></a>
                                            </div>
                                            <div class="col-3 p-md-5">
                                                <a href="#"><img class="img-fluid brand-img" src="<c:url value="assets/img/brand_014.png"/>"  alt="Brand Logo"></a>
                                            </div>
                                        </div>
                                    </div>
                                    <!--End Second slide-->
